...
import '../data/pointage_zone_repository.dart';
...
class PointageZoneProvider extends ChangeNotifier {
  ...
  PointageZoneProvider({
    required PointageZoneRepository repository,
  ...
  // Getters
  List<PointingZone> get pointages => List.unmodifiable(_pointages);
  PointageFilters get filters => _filters;
  PaginationState get pagination => _pagination;
  PointageZoneStats? get stats => _stats;
  ...
  Future<void> _initialize() async {
    try {
      ...
      debugPrint('Error initializing PointageZoneProvider: $e');
    }
  }
    ...
    try {
      ...
      if (cached != null) {
        ...
        if (itemsList != null) {
          ...
          debugPrint('Loaded ${_pointages.length} zone pointages from cache');
          return true;
        }
      }
    } catch (e) {
  ...
  Future<void> _saveToCache() async {
    try {
      ...
      debugPrint('Saved ${serializedItems.length} zone pointages to cache');
    } catch (e) {
  ...
  void _handleError(dynamic error, StackTrace? stackTrace) {
    debugPrint('Error in PointageZoneProvider: $error');
    if (stackTrace != null) {
