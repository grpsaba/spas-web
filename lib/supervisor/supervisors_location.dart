  ...
  Future<void> addMarkerTomap() async {
    ...
    for (final location in _locations) {
      final marker = Marker(
        ...
        infoWindow: InfoWindow(
          title:
              '${location.supervisor?.firstName ?? ''} ${location.supervisor?.lastName ?? ''}',
          snippet: "${location.latlng.lat},${location.latlng.lng}",
        ),
      );
                      ...
                      SizedBox(
                        ...
                        child: FutureBuilder(
                            ...
                            builder: (context, snapshot) {
                              if (snapshot.hasData) {
                                List<Supervisor> data = snapshot.data
                                        ?.where((s) =>
                                    ...
                                    itemBuilder: (context, index) {
                                      ...
                                      return ListTile(
                                        onTap: () async {
                                          ...
                                          var locaion = await LocationService()
                                              .one(supervisor.UID);
                      ...
                      return StreamBuilder(
                          ...
                          builder: (context, snapshot) {
                            if (snapshot.hasData) {
                              ...
                              _locations = docs
                                  .map((e) => SuperviseurLocaion.fromJson(e))
                                  .toList();
                              var supFoloweds = _locations.where(
                                  (l) => l.supervisor == _supervisorFolowed);
                              ...
                              return GoogleMap(
                                ...
                                initialCameraPosition: CameraPosition(
                                    ...
                                    target: LatLng(
                                        supervisorFolowedLocaion != null
                                            ? supervisorFolowedLocaion
                                                .latlng.lat
                                            : _locations[0].latlng.lat,
                                        supervisorFolowedLocaion != null
                                            ? supervisorFolowedLocaion
                                                .latlng.lng
                                            : _locations[0].latlng.lng),
                                    zoom: 15),
                              );
                            } else {
                              return Center(
